 ...
 */
class GroupProjectRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, GroupProject::class);
    }

    // /**
    //  * @return GroupProject[] Returns an array of GroupProject objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?GroupProject
    {
        return $this->createQueryBuilder('g')
            ->andWhere('g.exampleField = :val')
            ->setParameter('val', $value)
